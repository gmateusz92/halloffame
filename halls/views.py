...
class DeleteVideo(LoginRequiredMixin, generic.DeleteView):
    ...
    def get_object(self): #funkcja służy do uzyskiwania obiektu wideo, ale przed zwróceniem go, sprawdza, czy użytkownik ma odpowiednie uprawnienia do usunięcia tego wideo.
...
class CreateHall(LoginRequiredMixin, generic.CreateView): #generic views to gdy uzytkownik nie musi byc zalogowany
    model = Hall
    fields = ['title']
...
class UpdateHall(LoginRequiredMixin, generic.UpdateView):
    ...
    def get_object(self): #funkcja służy do uzyskiwania obiektu hall, ale przed zwróceniem go, sprawdza, czy użytkownik ma odpowiednie uprawnienia do usunięcia tego wideo.
